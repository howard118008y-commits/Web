...
(function () {
  var css = [
    '.cx-nav{position:fixed;top:0;left:0;right:0;z-index:100;background:rgba(18,42,38,.92);',
    'backdrop-filter:blur(14px);border-bottom:1px solid #2C544D;font-family:"Noto Sans TC",-apple-system,"PingFang TC","Microsoft JhengHei",sans-serif;color:#F2EFE8}',
    ...
    '.cx-mark{width:30px;height:30px;border-radius:7px;background:#C8945A;color:#122A26;display:grid;place-items:center;font-size:16px;flex:none}',
    ...
    '.cx-dd a{display:block;padding:10px 12px;border-radius:8px;font-size:14px;color:#1B3B36}',
    '.cx-dd a:hover{background:rgba(200,148,90,.1)}',
    '.cx-dd a.go{font-weight:700;color:#122A26;background:#C8945A;margin-bottom:6px}',
    ...
    '.cx-phone{width:40px;height:40px;border-radius:50%;border:1px solid #2C544D;display:grid;place-items:center;font-size:15px;color:rgba(242,239,232,.8)}',
    ...
    '.cx-resume:hover{color:#F2EFE8;border-color:#2C544D}',
    '.cx-cta{background:#C8945A;color:#122A26;font-weight:700;font-size:14.5px;padding:10px 22px;border-radius:999px;white-space:nowrap}',
    ...
    '.cx-sheet{display:none;position:fixed;top:58px;left:0;right:0;bottom:0;background:#122A26;overflow:auto;padding:16px 20px 40px;z-index:99}',
    '.cx-sheet.open{display:block}',
    '.cx-sheet details{border-bottom:1px solid #2C544D}',
    ...
    '.cx-sheet .cx-sheet-foot a{padding:14px;border-radius:10px;border:1px solid #2C544D;text-align:center;font-size:15px}',
    '.cx-sheet .cx-sheet-foot a.cta{background:#C8945A;color:#122A26;border-color:#C8945A;font-weight:700}',
