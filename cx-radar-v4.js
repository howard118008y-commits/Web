...
(function () {
  ...
  function chart(points, unit) {
    ...
    return '<svg viewBox="0 0 ' + w + ' ' + h + '" preserveAspectRatio="none" style="width:100%;height:132px;display:block">'
      ...
      + '<stop offset="0%" stop-color="rgba(200,16,46,.16)"/><stop offset="100%" stop-color="rgba(200,16,46,0)"/></linearGradient></defs>'
      ...
      + '<path d="' + d + '" fill="none" stroke="#c8102e" stroke-width="2" vector-effect="non-scaling-stroke"/>'
      + '<circle cx="' + X(n - 1) + '" cy="' + Y(last[1]) + '" r="3.5" fill="#c8102e"/>'
